# 🦞 AgentMe — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/agentme/agentme/main/docs/assets/agentme-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/agentme/agentme/main/docs/assets/agentme-logo-text.png" alt="AgentMe" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/agentme/agentme/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/agentme/agentme/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/agentme/agentme/releases"><img src="https://img.shields.io/github/v/release/agentme/agentme?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**AgentMe** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://agentme.ai) · [Docs](https://docs.agentme.ai) · [DeepWiki](https://deepwiki.com/agentme/agentme) · [Getting Started](https://docs.agentme.ai/start/getting-started) · [Updating](https://docs.agentme.ai/install/updating) · [Showcase](https://docs.agentme.ai/start/showcase) · [FAQ](https://docs.agentme.ai/start/faq) · [Wizard](https://docs.agentme.ai/start/wizard) · [Nix](https://github.com/agentme/nix-agentme) · [Docker](https://docs.agentme.ai/install/docker) · [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (`agentme onboard`) in your terminal.
The wizard guides you step by step through setting up the gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.agentme.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.6** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.agentme.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.agentme.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.agentme.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.agentme.ai/start/getting-started)
...
Upgrading? [Updating guide](https://docs.agentme.ai/install/updating) (and run `agentme doctor`).
...
Switch channels (git + npm): `agentme update --channel stable|beta|dev`.
Details: [Development channels](https://docs.agentme.ai/install/development-channels).
...
Note: `pnpm agentme ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `agentme` binary.

## Security defaults (DM access)

AgentMe connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.agentme.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `agentme pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
...
- **[Multi-channel inbox](https://docs.agentme.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.agentme.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.agentme.ai/nodes/voicewake) + [Talk Mode](https://docs.agentme.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.agentme.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.agentme.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.agentme.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.agentme.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.agentme.ai/nodes).
- **[Onboarding](https://docs.agentme.ai/start/wizard) + [skills](https://docs.agentme.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=agentme/agentme&type=date&legend=top-left)](https://www.star-history.com/#agentme/agentme&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.agentme.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.agentme.ai/web), and [Canvas host](https://docs.agentme.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.agentme.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.agentme.ai/start/wizard), and [doctor](https://docs.agentme.ai/gateway/doctor).
- [Pi agent runtime](https://docs.agentme.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.agentme.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.agentme.ai/concepts/groups).
- [Media pipeline](https://docs.agentme.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.agentme.ai/nodes/audio).

### Channels

- [Channels](https://docs.agentme.ai/channels): [WhatsApp](https://docs.agentme.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.agentme.ai/channels/telegram) (grammY), [Slack](https://docs.agentme.ai/channels/slack) (Bolt), [Discord](https://docs.agentme.ai/channels/discord) (discord.js), [Google Chat](https://docs.agentme.ai/channels/googlechat) (Chat API), [Signal](https://docs.agentme.ai/channels/signal) (signal-cli), [BlueBubbles](https://docs.agentme.ai/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.agentme.ai/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.agentme.ai/channels/msteams) (extension), [Matrix](https://docs.agentme.ai/channels/matrix) (extension), [Zalo](https://docs.agentme.ai/channels/zalo) (extension), [Zalo Personal](https://docs.agentme.ai/channels/zalouser) (extension), [WebChat](https://docs.agentme.ai/web/webchat).
- [Group routing](https://docs.agentme.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.agentme.ai/channels).

### Apps + nodes

- [macOS app](https://docs.agentme.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.agentme.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.agentme.ai/nodes/talk) overlay, [WebChat](https://docs.agentme.ai/web/webchat), debug tools, [remote gateway](https://docs.agentme.ai/gateway/remote) control.
- [iOS node](https://docs.agentme.ai/platforms/ios): [Canvas](https://docs.agentme.ai/platforms/mac/canvas), [Voice Wake](https://docs.agentme.ai/nodes/voicewake), [Talk Mode](https://docs.agentme.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.agentme.ai/platforms/android): [Canvas](https://docs.agentme.ai/platforms/mac/canvas), [Talk Mode](https://docs.agentme.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.agentme.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.agentme.ai/tools/browser): dedicated agentme Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.agentme.ai/platforms/mac/canvas): [A2UI](https://docs.agentme.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.agentme.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.agentme.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.agentme.ai/automation/cron-jobs); [webhooks](https://docs.agentme.ai/automation/webhook); [Gmail Pub/Sub](https://docs.agentme.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.agentme.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.agentme.ai/concepts/channel-routing), [retry policy](https://docs.agentme.ai/concepts/retry), and [streaming/chunking](https://docs.agentme.ai/concepts/streaming).
- [Presence](https://docs.agentme.ai/concepts/presence), [typing indicators](https://docs.agentme.ai/concepts/typing-indicators), and [usage tracking](https://docs.agentme.ai/concepts/usage-tracking).
- [Models](https://docs.agentme.ai/concepts/models), [model failover](https://docs.agentme.ai/concepts/model-failover), and [session pruning](https://docs.agentme.ai/concepts/session-pruning).
- [Security](https://docs.agentme.ai/gateway/security) and [troubleshooting](https://docs.agentme.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.agentme.ai/web) + [WebChat](https://docs.agentme.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.agentme.ai/gateway/tailscale) or [SSH tunnels](https://docs.agentme.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.agentme.ai/install/nix) for declarative config; [Docker](https://docs.agentme.ai/install/docker)-based installs.
- [Doctor](https://docs.agentme.ai/gateway/doctor) migrations, [logging](https://docs.agentme.ai/logging).
...
- **[Gateway WebSocket network](https://docs.agentme.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.agentme.ai/gateway)).
- **[Tailscale exposure](https://docs.agentme.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.agentme.ai/gateway/remote)).
- **[Browser control](https://docs.agentme.ai/tools/browser)** — agentme‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.agentme.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.agentme.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.agentme.ai/nodes/voicewake) + [Talk Mode](https://docs.agentme.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.agentme.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

AgentMe can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (AgentMe enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.agentme.ai/gateway/tailscale) · [Web surfaces](https://docs.agentme.ai/web)
...
Details: [Remote access](https://docs.agentme.ai/gateway/remote) · [Nodes](https://docs.agentme.ai/nodes) · [Security](https://docs.agentme.ai/gateway/security)
...
Details: [Nodes](https://docs.agentme.ai/nodes) · [macOS app](https://docs.agentme.ai/platforms/macos) · [Gateway protocol](https://docs.agentme.ai/concepts/architecture)
...
Details: [Session tools](https://docs.agentme.ai/concepts/session-tool)
...
- Controlled via `agentme nodes …`.

Runbook: [iOS connect](https://docs.agentme.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.agentme.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.agentme/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.agentme/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.agentme/agentme.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.agentme.ai/gateway/configuration)
...
Details: [Security guide](https://docs.agentme.ai/gateway/security) · [Docker + sandboxing](https://docs.agentme.ai/install/docker) · [Sandbox config](https://docs.agentme.ai/gateway/configuration)

### [WhatsApp](https://docs.agentme.ai/channels/whatsapp)

- Link the device: `pnpm agentme channels login` (stores creds in `~/.agentme/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.agentme.ai/channels/telegram)
...
### [Slack](https://docs.agentme.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.agentme.ai/channels/discord)
...
### [Signal](https://docs.agentme.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.agentme.ai/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.agentme.ai/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.agentme.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.agentme.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.agentme.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.agentme.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.agentme.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.agentme.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.agentme.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.agentme.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.agentme.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.agentme.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.agentme.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.agentme.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.agentme.ai/platforms/windows), [Linux](https://docs.agentme.ai/platforms/linux), [macOS](https://docs.agentme.ai/platforms/macos), [iOS](https://docs.agentme.ai/platforms/ios), [Android](https://docs.agentme.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.agentme.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.agentme.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.agentme.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.agentme.ai/gateway/bonjour)
- [Gateway pairing](https://docs.agentme.ai/gateway/pairing)
- [Remote gateway README](https://docs.agentme.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.agentme.ai/web/control-ui)
- [Dashboard](https://docs.agentme.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.agentme.ai/gateway/health)
- [Gateway lock](https://docs.agentme.ai/gateway/gateway-lock)
- [Background process](https://docs.agentme.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.agentme.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.agentme.ai/logging)

## Deep dives

- [Agent loop](https://docs.agentme.ai/concepts/agent-loop)
- [Presence](https://docs.agentme.ai/concepts/presence)
- [TypeBox schemas](https://docs.agentme.ai/concepts/typebox)
- [RPC adapters](https://docs.agentme.ai/reference/rpc)
- [Queue](https://docs.agentme.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.agentme.ai/tools/skills-config)
- [Default AGENTS](https://docs.agentme.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.agentme.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.agentme.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.agentme.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.agentme.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.agentme.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.agentme.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.agentme.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.agentme.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.agentme.ai/platforms/mac/voicewake)
- [iOS node](https://docs.agentme.ai/platforms/ios)
- [Android node](https://docs.agentme.ai/platforms/android)
- [Windows (WSL2)](https://docs.agentme.ai/platforms/windows)
- [Linux app](https://docs.agentme.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.agentme.ai/gmail-pubsub](https://docs.agentme.ai/automation/gmail-pubsub)

## Molty

AgentMe was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [agentme.ai](https://agentme.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@agentme](https://x.com/agentme)
...
<p align="left">
  ...
  <a href="https://github.com/ryancnelson"><img src="https://avatars.githubusercontent.com/u/347171?v=4&s=48" width="48" height="48" alt="ryancnelson" title="ryancnelson"/></a> <a href="https://github.com/search?q=Samrat%20Jha"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="Samrat Jha" title="Samrat Jha"/></a> <a href="https://github.com/search?q=seans-agentmebot"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="seans-agentmebot" title="seans-agentmebot"/></a> <a href="https://github.com/senoldogann"><img src="https://avatars.githubusercontent.com/u/45736551?v=4&s=48" width="48" height="48" alt="senoldogann" title="senoldogann"/></a> <a href="https://github.com/Seredeep"><img src="https://avatars.githubusercontent.com/u/22802816?v=4&s=48" width="48" height="48" alt="Seredeep" title="Seredeep"/></a> <a href="https://github.com/sergical"><img src="https://avatars.githubusercontent.com/u/3760543?v=4&s=48" width="48" height="48" alt="sergical" title="sergical"/></a> <a href="https://github.com/search?q=shatner"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="shatner" title="shatner"/></a> <a href="https://github.com/shiv19"><img src="https://avatars.githubusercontent.com/u/9407019?v=4&s=48" width="48" height="48" alt="shiv19" title="shiv19"/></a> <a href="https://github.com/shiyuanhai"><img src="https://avatars.githubusercontent.com/u/1187370?v=4&s=48" width="48" height="48" alt="shiyuanhai" title="shiyuanhai"/></a> <a href="https://github.com/Shrinija17"><img src="https://avatars.githubusercontent.com/u/199155426?v=4&s=48" width="48" height="48" alt="Shrinija17" title="Shrinija17"/></a>
