---
summary: "First-run onboarding flow for AgentMe (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give AgentMe">
...
<Step title="CLI">
  ...
  The app can install the global `agentme` CLI via npm/pnpm so terminal
