...
AgentMe treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.agentme/settings/voicewake.json`

Shape:

```json
{ "triggers": ["agentme", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
