...
- Same path: run the app from a fixed location (for AgentMe, `dist/AgentMe.app`).
...
Workaround: move files into the AgentMe workspace (`~/.agentme/workspace`) if you want to avoid per-folder grants.
