...
AgentMe has two separate “streaming” layers:
...
When block streaming is enabled, AgentMe can **merge consecutive block chunks**
...
When draft streaming is active, AgentMe disables block streaming for that reply to avoid double-streaming.
