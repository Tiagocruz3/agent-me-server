---
summary: "Use Qianfan's unified API to access many models in AgentMe"
read_when:
...
3. AgentMe installed on your system
...
4. Copy the API key for use with AgentMe

## CLI setup

```bash
agentme onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [AgentMe Configuration](/gateway/configuration)
