---
summary: "Use Qwen OAuth (free tier) in AgentMe"
read_when:
  - You want to use Qwen with AgentMe
...
If you already logged in with the Qwen Code CLI, AgentMe will sync credentials
