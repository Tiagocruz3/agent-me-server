...
You can point AgentMe at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or AgentMe
...
- [Anthropic provider](/providers/anthropic) - Native AgentMe integration with Claude setup-token or API keys
