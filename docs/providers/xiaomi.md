---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with AgentMe"
read_when:
  - You want Xiaomi MiMo models in AgentMe
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). AgentMe uses
