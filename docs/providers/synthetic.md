---
summary: "Use Synthetic's Anthropic-compatible API in AgentMe"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. AgentMe registers it as the
...
Note: AgentMe's Anthropic client appends `/v1` to the base URL, so use
