...
- Install via CLI: `agentme plugins install @agentme/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `agentme plugins install ./extensions/zalo`
   - From npm (if published): `agentme plugins install @agentme/zalo`
...
- Approve via:
  - `agentme pairing list zalo`
  - `agentme pairing approve zalo <CODE>`
...
- Example: `agentme message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `agentme channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `agentme logs --follow`
