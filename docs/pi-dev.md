...
This guide summarizes a sane workflow for working on the pi integration in AgentMe.
...
- Trigger the agent directly:
  - `pnpm agentme agent --message "Hello" --thinking low`
...
State lives under the AgentMe state directory. Default is `~/.agentme`. If `AGENTME_STATE_DIR` is set, use that directory instead.

To reset everything:

- `agentme.json` for config
...
- [https://docs.agentme.ai/testing](https://docs.agentme.ai/testing)
- [https://docs.agentme.ai/start/getting-started](https://docs.agentme.ai/start/getting-started)
