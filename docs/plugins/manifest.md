...
read_when:
  - You are building a AgentMe plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (agentme.plugin.json)

Every plugin **must** ship a `agentme.plugin.json` file in the **plugin root**.
AgentMe uses this manifest to validate configuration **without executing plugin
