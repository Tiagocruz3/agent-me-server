...
本指南总结了在 AgentMe 中开发 Pi 集成的合理工作流程。
...
状态存储在 AgentMe 状态目录下。默认为 `~/.agentme`。如果设置了 `AGENTME_STATE_DIR`，则使用该目录。
...
- https://docs.agentme.ai/testing
- https://docs.agentme.ai/start/getting-started
