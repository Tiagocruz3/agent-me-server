...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: AgentMeConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: AgentMeConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: AgentMeConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: AgentMeConfig): void {
