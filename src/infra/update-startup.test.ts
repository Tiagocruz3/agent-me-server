...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "agentme-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveAgentMePackageRoot } = await import("./agentme-root.js");
    ...
    vi.mocked(resolveAgentMePackageRoot).mockResolvedValue("/opt/agentme");
