...
export type { AgentMeConfig } from "../config/config.js";
/** @deprecated Use AgentMeConfig instead */
export type { AgentMeConfig as ClawdbotConfig } from "../config/config.js";
