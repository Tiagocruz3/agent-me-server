...
export function listBindings(cfg: AgentMeConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: AgentMeConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: AgentMeConfig) {
