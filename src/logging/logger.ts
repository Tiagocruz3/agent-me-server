...
export const DEFAULT_LOG_DIR = "/tmp/agentme";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "agentme.log"); // legacy single-file path

const LOG_PREFIX = "agentme";
...
function resolveSettings(): ResolvedSettings {
  let cfg: AgentMeConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => AgentMeConfig;
      };
