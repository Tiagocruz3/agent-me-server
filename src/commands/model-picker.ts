...
function resolveConfiguredModelRaw(cfg: AgentMeConfig): string {
...
function resolveConfiguredModelKeys(cfg: AgentMeConfig): string[] {
...
export function applyPrimaryModel(cfg: AgentMeConfig, model: string): AgentMeConfig {
...
export function applyModelAllowlist(cfg: AgentMeConfig, models: string[]): AgentMeConfig {
  const defaults = cfg.agents?.defaults;
