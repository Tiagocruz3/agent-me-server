...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.agentme.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("agentme hooks list")}`,
      `  ${formatCliCommand("agentme hooks enable <name>")}`,
      `  ${formatCliCommand("agentme hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
