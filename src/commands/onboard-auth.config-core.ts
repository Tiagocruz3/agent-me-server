...
export function applyZaiConfig(cfg: AgentMeConfig): AgentMeConfig {
...
export function applyOpenrouterProviderConfig(cfg: AgentMeConfig): AgentMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: AgentMeConfig): AgentMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: AgentMeConfig): AgentMeConfig {
...
export function applyOpenrouterConfig(cfg: AgentMeConfig): AgentMeConfig {
...
export function applyMoonshotProviderConfig(cfg: AgentMeConfig): AgentMeConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: AgentMeConfig): AgentMeConfig {
...
export function applyMoonshotConfig(cfg: AgentMeConfig): AgentMeConfig {
...
export function applyMoonshotConfigCn(cfg: AgentMeConfig): AgentMeConfig {
...
export function applyKimiCodeProviderConfig(cfg: AgentMeConfig): AgentMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: AgentMeConfig): AgentMeConfig {
...
export function applySyntheticProviderConfig(cfg: AgentMeConfig): AgentMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: AgentMeConfig): AgentMeConfig {
...
export function applyXiaomiProviderConfig(cfg: AgentMeConfig): AgentMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: AgentMeConfig): AgentMeConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: AgentMeConfig): AgentMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: AgentMeConfig): AgentMeConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: AgentMeConfig): AgentMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: AgentMeConfig): AgentMeConfig {
...
export function applyXaiProviderConfig(cfg: AgentMeConfig): AgentMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: AgentMeConfig): AgentMeConfig {
...
export function applyQianfanProviderConfig(cfg: AgentMeConfig): AgentMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: AgentMeConfig): AgentMeConfig {
