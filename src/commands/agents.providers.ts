...
function resolveDefaultAccountId(cfg: AgentMeConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: AgentMeConfig): boolean {
...
export function summarizeBindings(cfg: AgentMeConfig, bindings: AgentBinding[]): string[] {
