...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "agentme-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<AgentMeConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<AgentMeConfig["telegram"]>>,
