...
const ensureAgentMeModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveAgentMeAgentDir = vi.fn().mockReturnValue("/tmp/agentme-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/agentme-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureAgentMeModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveAgentMeAgentDir,
}));
