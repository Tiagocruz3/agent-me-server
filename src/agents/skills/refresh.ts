...
function resolveWatchPaths(workspaceDir: string, config?: AgentMeConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: AgentMeConfig }) {
