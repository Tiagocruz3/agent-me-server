...
describe("createAgentMeCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createAgentMeCodingTools({
      config,
    ...
    const anthropicTools = createAgentMeCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createAgentMeCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createAgentMeCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
