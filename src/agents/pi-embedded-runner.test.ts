...
beforeAll(async () => {
  ...
  tempRoot = await fs.mkdtemp(path.join(os.tmpdir(), "agentme-embedded-agent-"));
...
const ensureModels = (cfg: AgentMeConfig) => ensureAgentMeModelsJson(cfg, agentDir) as unknown;
