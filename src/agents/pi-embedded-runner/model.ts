...
// pi-ai's built-in Anthropic catalog can lag behind AgentMe's defaults/docs.
...
export function buildModelAliasLines(cfg?: AgentMeConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveAgentMeAgentDir();
