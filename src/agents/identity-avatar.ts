...
function resolveAvatarSource(cfg: AgentMeConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AgentMeConfig, agentId: string): AgentAvatarResolution {
