...
function resolveMainSessionKeyForSandbox(params: { cfg?: AgentMeConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: AgentMeConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`agentme sandbox explain --session ${runtime.sessionKey}`)}`,
  );
