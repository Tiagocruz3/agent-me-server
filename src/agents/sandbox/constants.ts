...
export const DEFAULT_SANDBOX_IMAGE = "agentme-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "agentme-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "agentme-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "agentme-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "agentme-sbx-browser-";
