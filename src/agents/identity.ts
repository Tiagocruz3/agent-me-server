import type { AgentMeConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: AgentMeConfig, agentId: string): string {
...
export function resolveIdentityNamePrefix(cfg: AgentMeConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: AgentMeConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[agentme]";
}
