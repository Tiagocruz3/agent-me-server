...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveAgentMeAgentDir() returns mainAgentDir
    process.env.AGENTME_STATE_DIR = tmpDir;
    process.env.AGENTME_AGENT_DIR = mainAgentDir;
