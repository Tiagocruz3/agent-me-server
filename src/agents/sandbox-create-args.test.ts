  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "agentme.sandbox=1",
        "--label",
        "agentme.sessionKey=main",
        "--label",
        "agentme.createdAtMs=1700000000000",
        "--label",
        "agentme.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
