...
import type { AgentMeConfig, ConfigValidationIssue } from "./types.js";
...
function validateIdentityAvatar(config: AgentMeConfig): ConfigValidationIssue[] {
...
export function validateConfigObject(
  ...
  const validated = AgentMeSchema.safeParse(raw);
  ...
  const duplicates = findDuplicateAgentDirs(validated.data as AgentMeConfig);
  ...
  return {
    ...
    config: applyModelDefaults(
      applyAgentDefaults(applySessionDefaults(validated.data as AgentMeConfig)),
    ),
  };
}
