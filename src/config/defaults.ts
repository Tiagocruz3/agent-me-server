...
function resolveAnthropicDefaultAuthMode(cfg: AgentMeConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AgentMeConfig): AgentMeConfig {
...
export function applyTalkApiKey(config: AgentMeConfig): AgentMeConfig {
...
export function applyModelDefaults(cfg: AgentMeConfig): AgentMeConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AgentMeConfig): AgentMeConfig {
...
export function applyLoggingDefaults(cfg: AgentMeConfig): AgentMeConfig {
...
export function applyContextPruningDefaults(cfg: AgentMeConfig): AgentMeConfig {
...
export function applyCompactionDefaults(cfg: AgentMeConfig): AgentMeConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
