import type { AgentMeConfig } from "./config.js";
...
function isTelegramConfigured(cfg: AgentMeConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: AgentMeConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: AgentMeConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: AgentMeConfig): boolean {
...
function isIMessageConfigured(cfg: AgentMeConfig): boolean {
...
function isWhatsAppConfigured(cfg: AgentMeConfig): boolean {
...
function isGenericChannelConfigured(cfg: AgentMeConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: AgentMeConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: AgentMeConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: AgentMeConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: AgentMeConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: AgentMeConfig, pluginId: string): AgentMeConfig {
...
function registerPluginEntry(cfg: AgentMeConfig, pluginId: string): AgentMeConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
