...
export type ChannelAgentToolFactory = (params: { cfg?: AgentMeConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: AgentMeConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: AgentMeConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: AgentMeConfig }) => boolean;
  supportsCards?: (params: { cfg: AgentMeConfig }) => boolean;
