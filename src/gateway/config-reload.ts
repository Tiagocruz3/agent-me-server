...
import type { AgentMeConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: AgentMeConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: AgentMeConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: AgentMeConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: AgentMeConfig) => void;
  log: {
