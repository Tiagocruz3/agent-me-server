...
import { type AgentMeConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: AgentMeConfig): string[] {
...
export function listAgentsForGateway(cfg: AgentMeConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: AgentMeConfig): string {
...
function resolveSessionStoreAgentId(cfg: AgentMeConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: AgentMeConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: AgentMeConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: AgentMeConfig): GatewaySessionsDefaults {
