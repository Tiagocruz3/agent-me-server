...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @agentme/voice-call -> voice-call).
...
export function discoverAgentMePlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".agentme", "extensions")];
