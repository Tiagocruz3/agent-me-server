...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/agentme/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/agentme/extensions",
        global: "/Users/x/.agentme/extensions",
        workspace: "/Users/x/ws/.agentme/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.agentme/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/agentme/extensions",
        global: "/Users/x/.agentme/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.agentme/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/agentme/extensions",
        global: "/Users/x/.agentme/extensions",
