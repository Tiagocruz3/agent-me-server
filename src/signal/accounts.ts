...
export function listSignalAccountIds(cfg: AgentMeConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: AgentMeConfig): string {
...
function mergeSignalAccountConfig(cfg: AgentMeConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: AgentMeConfig): ResolvedSignalAccount[] {
