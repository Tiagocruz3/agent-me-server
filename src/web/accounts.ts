...
function listConfiguredAccountIds(cfg: AgentMeConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: AgentMeConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AgentMeConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: AgentMeConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: AgentMeConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: AgentMeConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AgentMeConfig): ResolvedWhatsAppAccount[] {
