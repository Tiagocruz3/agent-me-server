...
import type { AgentMePluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: AgentMePluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: AgentMePluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
