...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AgentMeConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AgentMeConfig; env: NodeJS.ProcessEnv }): {
  cfg: AgentMeConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
