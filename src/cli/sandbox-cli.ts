...
const SANDBOX_EXAMPLES = {
  main: [
    ["agentme sandbox list", "List all sandbox containers."],
    ["agentme sandbox list --browser", "List only browser containers."],
    ["agentme sandbox recreate --all", "Recreate all containers."],
    ["agentme sandbox recreate --session main", "Recreate a specific session."],
    ["agentme sandbox recreate --agent mybot", "Recreate agent containers."],
    ["agentme sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["agentme sandbox list", "List all sandbox containers."],
    ["agentme sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["agentme sandbox recreate --all", "Recreate all containers."],
    ["agentme sandbox recreate --session main", "Recreate a specific session."],
    ["agentme sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["agentme sandbox recreate --browser --all", "Recreate only browser containers."],
    ["agentme sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["agentme sandbox explain", "Show effective sandbox config."],
    ["agentme sandbox explain --session agent:main:main", "Explain a specific session."],
    ["agentme sandbox explain --agent work", "Explain an agent sandbox."],
    ["agentme sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.agentme.ai/cli/sandbox")}\n`,
    )
    .action(() => {
