...
import type { GatewayBindMode, GatewayTailscaleMode, AgentMeConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.agentme.ai/gateway/tailscale", "https://docs.agentme.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
