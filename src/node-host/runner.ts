...
import { ensureAgentMeCliOnPath } from "../infra/path-env.js";
...
const execHostEnforced = process.env.AGENTME_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed =
  process.env.AGENTME_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
...
function ensureNodePathEnv(): string {
  ensureAgentMeCliOnPath({ pathEnv: process.env.PATH ?? "" });
