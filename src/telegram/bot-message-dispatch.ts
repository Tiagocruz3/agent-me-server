...
import type { AgentMeConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: AgentMeConfig, agentId: string) {
  try {
