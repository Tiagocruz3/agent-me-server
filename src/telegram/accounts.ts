...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.AGENTME_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: AgentMeConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: AgentMeConfig): string {
...
function mergeTelegramAccountConfig(cfg: AgentMeConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: AgentMeConfig): ResolvedTelegramAccount[] {
