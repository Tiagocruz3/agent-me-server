...
export const A2UI_PATH = "/__agentme__/a2ui";

export const CANVAS_HOST_PATH = "/__agentme__/canvas";

export const CANVAS_WS_PATH = "/__agentme__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.agentmeCanvasA2UIAction.postMessage(...)
  // - Android: window.agentmeCanvasA2UIAction.postMessage(...)
  const handlerNames = ["agentmeCanvasA2UIAction"];
  ...
  globalThis.AgentMe = globalThis.AgentMe ?? {};
  globalThis.AgentMe.postMessage = postToNode;
  globalThis.AgentMe.sendUserAction = sendUserAction;
  globalThis.agentmePostMessage = postToNode;
  globalThis.agentmeSendUserAction = sendUserAction;
