...
- Version alignment with core AgentMe release numbers.
...
- First public release of the @agentme/voice-call plugin.
...
- CLI: `agentme voicecall` commands (call/start/continue/speak/end/status/tail/expose).
