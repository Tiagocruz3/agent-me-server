import type { ChannelOnboardingAdapter, AgentMeConfig, WizardPrompter } from "agentme/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.agentme.ai/channels/mattermost",
    ].join("\n"),
