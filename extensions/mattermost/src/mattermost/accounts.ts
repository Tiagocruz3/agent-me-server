...
export function listMattermostAccountIds(cfg: AgentMeConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: AgentMeConfig): string {
...
export function listEnabledMattermostAccounts(cfg: AgentMeConfig): ResolvedMattermostAccount[] {
