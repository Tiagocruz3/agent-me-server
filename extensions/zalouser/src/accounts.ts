...
export function listZalouserAccountIds(cfg: AgentMeConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: AgentMeConfig): string {
...
function mergeZalouserAccountConfig(cfg: AgentMeConfig, accountId: string): ZalouserAccountConfig {
