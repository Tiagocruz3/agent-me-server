...
This directory contains the **BlueBubbles external channel plugin** for AgentMe.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `agentme/plugin-sdk` helpers.
