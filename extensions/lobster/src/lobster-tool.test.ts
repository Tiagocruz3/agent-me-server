...
import type { AgentMePluginApi, AgentMePluginToolContext } from "../../../src/plugins/types.js";
import { createLobsterTool } from "./lobster-tool.js";

async function writeFakeLobsterScript(scriptBody: string, prefix = "agentme-lobster-plugin-") {
...
function fakeApi(overrides: Partial<AgentMePluginApi> = {}): AgentMePluginApi {
  return {
    id: "lobster",
    name: "lobster",
    source: "test",
...
function fakeCtx(overrides: Partial<AgentMePluginToolContext> = {}): AgentMePluginToolContext {
  return {
    config: {},
    workspaceDir: "/tmp",
    agentDir: "/tmp",
...
describe("lobster plugin tool", () => {
  ...
  it("can be gated off in sandboxed contexts", async () => {
    const api = fakeApi();
    const factoryTool = (ctx: AgentMePluginToolContext) => {
      if (ctx.sandboxed) {
        return null;
      }
