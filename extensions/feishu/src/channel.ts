import type { ChannelMeta, ChannelPlugin, ClawdbotConfig } from "agentme/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, PAIRING_APPROVED_MESSAGE } from "agentme/plugin-sdk";
