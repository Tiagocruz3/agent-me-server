## AgentMe Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_agentme-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm agentme gateway --port 18789 --verbose
```
