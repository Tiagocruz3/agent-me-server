...
public typealias AgentMePlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias AgentMePlatformImage = UIImage
#endif

public struct AgentMeChatUsageCost: Codable, Hashable, Sendable {
...
public struct AgentMeChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: AgentMeChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(AgentMeChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct AgentMeChatMessageContent: Codable, Hashable, Sendable {
...
public struct AgentMeChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [AgentMeChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: AgentMeChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [AgentMeChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: AgentMeChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(AgentMeChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([AgentMeChatMessageContent].self, forKey: .content) {
...
public struct AgentMeChatHistoryPayload: Codable, Sendable {
...
public struct AgentMeSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct AgentMeSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [AgentMeSessionPreviewItem]
}

public struct AgentMeSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [AgentMeSessionPreviewEntry]

    public init(ts: Int, previews: [AgentMeSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct AgentMeChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct AgentMeChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct AgentMeAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct AgentMeChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct AgentMeGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct AgentMePendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: AgentMePlatformImage?
...
public struct AgentMeChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
