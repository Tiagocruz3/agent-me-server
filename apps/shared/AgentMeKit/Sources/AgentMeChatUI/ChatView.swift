...
@MainActor
public struct AgentMeChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: AgentMeChatViewModel
    ...
    public init(
        viewModel: AgentMeChatViewModel,
    ...
    private var visibleMessages: [AgentMeChatMessage] {
        let base: [AgentMeChatMessage]
    ...
    private func mergeToolResults(in messages: [AgentMeChatMessage]) -> [AgentMeChatMessage] {
    ...
    private func isToolResultMessage(_ message: AgentMeChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: AgentMeChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: AgentMeChatMessage) -> String {
