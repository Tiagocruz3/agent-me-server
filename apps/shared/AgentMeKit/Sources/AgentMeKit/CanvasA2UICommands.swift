...
public enum AgentMeCanvasA2UICommand: String, Codable, Sendable {
...
public struct AgentMeCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct AgentMeCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
