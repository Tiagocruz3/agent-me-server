...
public enum AgentMeTalkCommand: String, Codable, Sendable {
...
public struct AgentMeTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct AgentMeTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
