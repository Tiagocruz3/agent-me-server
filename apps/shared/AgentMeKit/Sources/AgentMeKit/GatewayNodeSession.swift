...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.agentme", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.agentme", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: AgentMeProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
