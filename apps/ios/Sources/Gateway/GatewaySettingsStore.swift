...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.agentme.gateway"
    private static let nodeService = "ai.agentme.node"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.agentme.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.agentme.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("agentme-gateway.log")
    }
