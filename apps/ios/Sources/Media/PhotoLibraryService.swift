...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: AgentMePhotosLatestParams) async throws -> AgentMePhotosLatestPayload {
        ...
        var results: [AgentMePhotoPayload] = []
        ...
        return AgentMePhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> AgentMePhotoPayload
    {
