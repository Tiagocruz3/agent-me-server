...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = AgentMeLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = AgentMeLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.agentme.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(AgentMeLocationMode.off.rawValue)
                            Text("While Using").tag(AgentMeLocationMode.whileUsing.rawValue)
                            Text("Always").tag(AgentMeLocationMode.always.rawValue)
                        }
                        ...
                        Text("Keeps the screen awake while AgentMe is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = AgentMeLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private var locationMode: AgentMeLocationMode {
        AgentMeLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
