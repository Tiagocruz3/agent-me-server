...
final class ScreenController {
    ...
    /// Callback invoked when an agentme:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = AgentMeKitResources.bundle
...
/// Handles navigation policy to intercept agentme:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept agentme:// deep links.
        if url.scheme?.lowercased() == "agentme" {
