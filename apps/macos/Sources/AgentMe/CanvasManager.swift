...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.agentme", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("AgentMe/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__agentme__/a2ui/").absoluteString + "?platform=macos"
    }
