...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.agentme", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.agentme", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [AgentMeChatMessage] = messages.compactMap { item in
