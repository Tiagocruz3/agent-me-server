...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.agentme", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return AgentMeConfigFile.defaultWorkspaceURL() }
