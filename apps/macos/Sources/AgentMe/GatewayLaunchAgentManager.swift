...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.agentme", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".agentme/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.agentmeCommand(
            subcommand: "gateway",
