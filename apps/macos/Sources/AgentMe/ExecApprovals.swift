...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.agentme", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        AgentMePaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        AgentMePaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
