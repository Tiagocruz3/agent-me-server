...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = AgentMeConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = AgentMeConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = AgentMeConfigFile.loadDict()
            ...
            AgentMeConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/agentme"
        state.remoteCliPath = ""
        return state
    }
}
