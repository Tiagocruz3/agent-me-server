...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/agentme/agentme") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/agentme/agentme")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://agentme.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "AgentMeBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "AgentMeBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "AgentMeGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AgentMeGitCommit") as? String) ??
            "unknown"
    }
