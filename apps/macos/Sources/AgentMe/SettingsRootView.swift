...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .agentmeSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? AgentMePaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? AgentMePaths.stateDirURL.path
...
extension Notification.Name {
    static let agentmeSelectSettingsTab = Notification.Name("agentmeSelectSettingsTab")
}
