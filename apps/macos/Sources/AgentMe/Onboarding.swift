...
enum UIStrings {
    static let welcomeTitle = "Welcome to AgentMe"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: AgentMeOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: AgentMeChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g agentme@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: AgentMeChatViewModel(
