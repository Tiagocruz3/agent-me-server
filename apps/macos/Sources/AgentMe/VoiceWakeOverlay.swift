...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.agentme", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other AgentMe windows, but below the system’s pop-up menus.
