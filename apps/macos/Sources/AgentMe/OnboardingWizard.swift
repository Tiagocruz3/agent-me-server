...
private let onboardingWizardLogger = Logger(subsystem: "ai.agentme", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between AgentMeProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = AgentMeProtocol.AnyCodable
