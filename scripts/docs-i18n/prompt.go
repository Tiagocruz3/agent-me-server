...
- Keep product names in English: AgentMe, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the AgentMe Gateway, use “Gateway 网关”.
