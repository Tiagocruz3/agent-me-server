...
show_usage() {
    cat << EOF
clawlog - AgentMe Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View AgentMe logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    AgentMe logs flow through the macOS unified log (subsystem: ai.agentme).
