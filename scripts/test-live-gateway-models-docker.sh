...
docker run --rm -t \
  ...
  -e AGENTME_LIVE_GATEWAY_MODELS="${AGENTME_LIVE_GATEWAY_MODELS:-${CLAWDBOT_LIVE_GATEWAY_MODELS:-all}}" \
  -e AGENTME_LIVE_GATEWAY_PROVIDERS="${AGENTME_LIVE_GATEWAY_PROVIDERS:-${CLAWDBOT_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e AGENTME_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${AGENTME_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${CLAWDBOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
