...
# Output:
# - dist/AgentMe.app
# - dist/AgentMe-<version>.zip
# - dist/AgentMe-<version>.dmg
...
ZIP="$ROOT_DIR/dist/AgentMe-$VERSION.zip"
DMG="$ROOT_DIR/dist/AgentMe-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/AgentMe-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/AgentMe-$VERSION.dSYM.zip"
